package com.teamnoyes.lottonumberdrawer
...
class MainActivity : AppCompatActivity() {
    ...
    private var didRun = false // 이미 실행 중인지
    ...
    private fun initAddButton() {
        addButton.setOnClickListener {
            if (didRun) {
                Toast.makeText(this, "초기화 후에 시작해주세요", Toast.LENGTH_SHORT).show()
    ...
    private fun getRandomNumber(): List<Int> {
        ...
        //기존에 선택한 숫자들과 랜덤으로 나온 숫자들을 합쳐서 정렬한다.
